...
if(strlen($_REQUEST["cName"])==0){
	...
	$sql="update admin set Name='".$_REQUEST["cName"]."',Gender='".$_REQUEST["gender"]."',Phone='".$_REQUEST["phn"]."',Address='".$_REQUEST["address"]."',email='".$_REQUEST["email"]."',DOB='".$_REQUEST["bday"]."' where username='".$_SESSION["USERNAME"]."'";
	//loadFromMySQL($s);
