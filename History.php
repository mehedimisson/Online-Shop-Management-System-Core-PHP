...
session_start();
//$data=array();
//include("Admin\purchaseSale.php");
...
if(isset($_COOKIE["name"]) && $_COOKIE["valid"]=="SET"){
	...
	$sql="select * from orders where cususername='".$_SESSION["uname"]."'";?>
<table>		
		<?php
		//echo $sql;
		$result = mysqli_query($conn, $sql)or die(mysqli_error($conn));?>
			...
			<tr border="2px" width="100%" cellpadding="0px" cellspacing="0px" bgcolor="#4BBAD7">
				<td>
					<?php echo "Order ID"; echo str_repeat("&nbsp;",6); ?>
				</td>
				<td>
		...
		while($row = mysqli_fetch_assoc($result)) {
			...
			<tr border="2px" width="100%" cellpadding="0px" cellspacing="0px" bgcolor="#f1f1f1">
				<td>
					<?php echo $row["oid"];  echo str_repeat("&nbsp;",22); ?>
				</td>
				<td>
